...
| `Slides_IA_Educadores_2026.html` | Apresentação interativa: navegação por teclado, miniaturas, tela cheia, **cronômetro ao vivo nos desafios** e **demonstração ao vivo** (cards do banco abrem o prompt já copiado, com botões que abrem as IAs) |
